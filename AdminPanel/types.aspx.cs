...
public partial class AdminPanel_types : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.SelectCommand = "SELECT ID,NAME,LONG,CODE FROM VADIMTYPES";
        //  SqlDataSource1.UpdateCommand = "UPDATE FILTERS SET RUNAME=@RUNAME,AZNAME=@AZNAME,ENNAME=@ENNAME WHERE ID=@ID";
        SqlDataSource1.DeleteCommand = "DELETE FROM VADIMTYPES WHERE ID=@ID";
        if (!Page.IsPostBack)
        {
    ...
    protected void Save_btn_Click(object sender, EventArgs e)
    {
        using (SqlConnection Conn = new SqlConnection())
        {
            ...
            Conn.Open();
            Comm.CommandText = "INSERT INTO VADIMTYPES(NAME,LONG,CODE) VALUES(@NAME,@LONG,@CODE); SELECT SCOPE_IDENTITY()";
    ...
    protected void CategoriesGrid_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        if (e.CommandName == "UpdateCommand")
        {
            ...
            using (SqlConnection Conn = new SqlConnection())
            {
                ...
                SqlCommand comm = new SqlCommand();
                comm.Connection = Conn;
                comm.CommandText = @"SELECT ID,NAME,LONG,CODE FROM VADIMTYPES WHERE ID=@ID";
